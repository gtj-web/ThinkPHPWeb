...
<body>
  ...
  <ul class="nav navbar-nav navbar-right">
    ...
    <div class="container-fluid">
      ...
      <!-- 有错误信息时展示 -->
      <?php if(isset($error)): ?>
      <div class="alert <?php echo $error=='修改音乐成功' ? 'alert-success' : 'alert-info' ?>">
      ...
      <div class="row">
        <div class="col-md-12">
          <form action="" method="post" enctype="multipart/form-data">
            <h2>修改“<?php echo ($data["song"]); ?>”音乐</h2>
            <div class="form-group">
              <label for="song">歌的名称</label>
              <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
              <input id="song" class="form-control" name="song" type="text" placeholder="音乐名称" value="<?php echo ($data["song"]); ?>">
            </div>
            <div class="form-group">
              <label for="singer">歌手名</label>
              <input id="singer" class="form-control" name="singer" type="text" placeholder="歌手名" value="<?php echo ($data["singer"]); ?>">
            </div>
            <div class="form-group">
