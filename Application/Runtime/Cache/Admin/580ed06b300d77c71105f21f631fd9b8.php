  ...
  <ul class="nav navbar-nav navbar-right">
    ...
    <div class="container-fluid">
      <div class="page-title">
        <h1>编辑"<?php echo ($data["title"]); ?>"文章</h1>
      </div>
      <!-- 有错误信息时展示 -->
      <?php if(isset($error)): ?>
      ...
      <form class="row" action="" method="post">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input id="title" class="form-control input-lg" name="title" type="text" placeholder="文章标题" value="<?php echo ($data["title"]); ?>">
          </div>
          <div class="form-group">
            <label for="content">内容</label>
            <div id="test-editor" name="content">
                <textarea style="display:none;" name="content"><?php echo ($data["content"]); ?></textarea>
            </div>
          </div>
          <div class="form-group">
...
<ul class="nav">
  ...
  <li>
    ...
    <ul id="menu-music" class="collapse">
      ...
      <li class="active"><a href="add-music.php">添加音乐</a></li>
      <li><a href="categories.html">分类目录</a></li>
    </ul>
  </li>
  <li>
